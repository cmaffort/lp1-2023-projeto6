...
public class PromocaoDeFIdelidadeDAO extends AbstractDAO implements IPromocaoDeFidelidadeDAO {
    @Override
    ...
    @Override
    public Long inserir(PromocaoDeFidelidade promocaoDeFidelidade) throws PersistenceException {
        return null;
    }

    @Override
    public boolean alterar(PromocaoDeFidelidade promocaoDeFidelidade) throws PersistenceException {
        return false;
    }

    @Override
    public boolean remover(PromocaoDeFidelidade promocaoDeFidelidade) throws PersistenceException {
        return false;
    }

    @Override
    public List<PromocaoDeFidelidade> listar() throws PersistenceException {
        return null;
    }
