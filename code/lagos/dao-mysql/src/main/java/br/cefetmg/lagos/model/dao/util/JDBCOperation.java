...
public class JDBCOperation<DataTransferObject extends DTO<DataTransferObject>> {
    ...
    public static class Builder<DataTransferObject extends DTO<DataTransferObject>> {
        ...
        public JDBCOperation<DataTransferObject> build(int autoGeneratedKeys) throws PersistenceException {
        ...
        public JDBCOperation<DataTransferObject> build() throws PersistenceException {
            return new JDBCOperation<>(contextDto, sql, Statement.NO_GENERATED_KEYS, columnsPreparedStatement, columnsResultSet, dtos);
        }
        ...
        public Long getId() throws PersistenceException {
            JDBCOperation<DataTransferObject> operation = build(Statement.RETURN_GENERATED_KEYS);
