...
public class JDBCOperation {
    ...
    private final DTODb dtoDb;

    private List<String> columnsPreparedStatement;

    public JDBCOperation(DTODb dtoDb, String sql, List<String> columnsPreparedStatement, int autoGeneratedKeys)
    ...
    public JDBCOperation(DTODb dtoDb, String sql, List<String> columnsPreparedStatement)
            throws SQLException, ClassNotFoundException {
        this.dtoDb = dtoDb;
        setConnection();
