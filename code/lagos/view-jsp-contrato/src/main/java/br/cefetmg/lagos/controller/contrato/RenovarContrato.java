...
@WebServlet(name="RenovarContrato", urlPatterns= {"/renovarcontrato"})
public class RenovarContrato extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            periodo.setPeriodo(Integer.parseInt(request.getParameter("periodoContrato")));
            periodo.setQuantidadeDiasPorPeriodo(Integer.parseInt(request.getParameter("duracaoPeriodo")));
            ...
            for (ContratoAssinado contratos : contratosAss){
                if (contratos.getUsuario().getId().equals(Long.parseLong(request.getParameter("usuario")))){
                    periodo.setId(contratos.getContrato().getPeriodicidade().getId());
                    contratos.getContrato().setPeriodicidade(periodo);
